...
const socialLinks = [
    {
      href: 'https://github.com/alwaysnani7',
    ...
    {
      href: 'https://www.linkedin.com/in/narnavaram-reddy-jagadeesh-776341293/',
      icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <section className="section" id='contact'>
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            ...
            <form action="https://getform.io/f/bqompwrb" method='POST' className="xl:pl-10 2xl:pl-20">
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    <div className="mb-4">
                        <label htmlFor="name" className="label reveal-up">
                            Name
                        </label>
                        <input type="text" name="name" id="name" autoComplete='name' required placeholder='Jagadeesh' className="text-field reveal-up" />
                    </div>
                    <div className="mb-4">
                        <label htmlFor="email" className="label reveal-up">
                            Email
                        </label>
                        <input type="text" name="email" id="email" autoComplete='email' required placeholder='jagadeesh@example.com' className="text-field reveal-up" />
                    </div>
                </div>
                <div className="mb-4">
