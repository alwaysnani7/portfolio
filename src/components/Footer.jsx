        ...
        <div className="container">
            ...
            <div className="lg:grid lg:grid-cols-2">
                ...
                <div className="mb-10">
                    ...
                    <ButtonPrimary href="mailto:narnavaramjagadeesh@gmail.com" label="Start Project" icon="chevron_right" classes="reveal-up"/>
                </div>
            ...
            <div className="flex items-center justify-between pt-10">
                ...
                <p className='text-zinc-500 text-sm reveal-up mb-20'>
                    &copy; {new Date().getFullYear()} <span className='text-zinc-200'>narnavaramreddyjagadeesh</span>
                </p>
            </div>
